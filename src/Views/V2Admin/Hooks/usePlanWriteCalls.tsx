...
import { writeBadgeAtom } from '../v2AdminAtom';
import { toFixed } from '@Utils/NumString';
import { useContext } from 'react';
import { ViewContext } from '..';
import { IPrice } from '../v2AdminAtom';



export const usePlanEditCalls = () => {
  const { activeChain } = useContext(ViewContext);
  const { writeCall } = useWriteCall(V2ADMIN_CONFIG[activeChain?.id].MuchoBadgeManager, MuchoBadgeManagerABI);
