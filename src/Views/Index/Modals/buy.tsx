...
import { IMuchoIndexDataPrice, IMuchoTokenLauncherData, indexAtom } from '../IndexAtom';
...
export const IndexBuyModal = ({ }: {}) => {
  ...
  const data: IMuchoTokenLauncherData = activeModal.data;
...
const Buy = ({ data, call, priceData }: { data: IMuchoTokenLauncherData, call: any, priceData: IMuchoIndexDataPrice }) => {
