...
import { OnRampStatusB2B } from './Components/OnRampStatusB2B';
...
export const RampPageB2B = () => {
  useEffect(() => {
    document.title = "(mucho) finance | Corporate On & Off ramp";
  }, []);
            ...
            <div className="root w-[100vw]">
              <main className="content-drawer">
                <Styles>
                  <RampModals />
                  <Section
                    Heading={<div className={topStyles}>{t("ramp.On & Off Ramp for Business")}</div>}
                    ...
                    other={<>
                      ...
                      {rampState.loginStatus == ERampStatus.LOGGED && <OnRampStatusB2B />}
                      <OnRampSumsubKYC />
                    </>}
                  />
