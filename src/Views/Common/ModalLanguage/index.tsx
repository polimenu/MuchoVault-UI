            ...
            <div className="text-1 bg-2 p-6 rounded-md relative">
                {pageState.isModalOpen && <div>
                    ...
                    <div className="flex items-center gap-[24px] whitespace-nowrap ml-[8px]">
                        {LANGUAGES.map(l => <img key={`switchlang_${l.code}`} src={`/lang_${l.code}.png`} className='hover:bg-1 hover:text-1 hover:brightness-125 cursor-pointer mt-2' width={"75px"} height={"75px"} onClick={() => {
